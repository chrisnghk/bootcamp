...
public class JavaQuest28 {
    public static void main(String[] args) {
        System.out.println(
                StringsNumber(new String[] {"a", "abc", "bc", "d"}, "abc")); // output : 3
        System.out.println(StringsNumber(new String[] {"a", "b", "c", "d"},
                "aaaabbababba")); // output : 2
        System.out.println(
                StringsNumber(new String[] {"xyz", "x", "y", "z"}, "abc")); // output : 0
        System.out
                .println(StringsNumber(new String[] {"a", "a", "a", ""}, "ab")); // output : 3
    }
