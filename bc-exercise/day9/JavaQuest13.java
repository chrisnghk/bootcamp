public class JavaQuest13 {
  ...
  public static double convertKelvin(double sourceCelsius) {
    return sourceCelsius + 273.15;
  }

  // Fahrenheit (華氏) = Celsius (攝氏) * 1.80 + 32.00
  // Code a method here to return temperature in Fahrenheit, by inputting temperature in Celsius
  public static double convertFahrenheit(double sourceCelsius) {
    return sourceCelsius * 1.80 + 32.00;
  }
