...
import com.hkjava.demo.demofinnhub.model.CompanyP;
import com.hkjava.demo.demofinnhub.model.CompanyPList;
...
public class CompanyServiceImpl implements CompanyService {
  ...
  private String companyProfilesEndpoint;
  ...
  public void getCompanyProfiles() {
    String url = UriComponentsBuilder.newInstance() //
        ...
        .host(domain) //
        .pathSegment(baseUrl) //
        .path(companyProfilesEndpoint) //
        .queryParam("exchange", "US") //
        .queryParam("token", token) //
        .build() //
        .toUriString();
    System.out.println("url=" + url);
    CompanyPList response = restTemplate.getForObject(url, CompanyPList.class);
